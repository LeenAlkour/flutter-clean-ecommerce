...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ButtonState);
}
...
/// @nodoc
class $ButtonStateCopyWith<$Res>  {
$ButtonStateCopyWith(ButtonState _, $Res Function(ButtonState) __);
}


/// Adds pattern-matching-related methods to [ButtonState].
extension ButtonStatePatterns on ButtonState {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function()?  success,TResult Function( String msg)?  error,required TResult orElse(),}) {final _that = this;
switch (_that) {
case Initial() when initial != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function()  success,required TResult Function( String msg)  error,}) {final _that = this;
switch (_that) {
case Initial():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function()?  success,TResult? Function( String msg)?  error,}) {final _that = this;
switch (_that) {
case Initial() when initial != null:
return initial();case Loading() when loading != null:
return loading();case Success() when success != null:
...
class Initial implements ButtonState {
  const Initial();
...
@override
String toString() {
  return 'ButtonState.error(msg: $msg)';
}
...
/// @nodoc
abstract mixin class $ErrorCopyWith<$Res> implements $ButtonStateCopyWith<$Res> {
