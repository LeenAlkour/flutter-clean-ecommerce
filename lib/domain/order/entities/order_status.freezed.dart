...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is OrderStatusEntity&&(identical(other.title, title) || other.title == title)&&(identical(other.done, done) || other.done == done)&&(identical(other.createDate, createDate) || other.createDate == createDate));
}
...
@pragma('vm:prefer-inline') @override $Res call({Object? title = null,Object? done = null,Object? createDate = null,}) {
  return _then(OrderStatusEntity(
