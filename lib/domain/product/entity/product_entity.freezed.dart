...
mixin _$ProductEntity {
 ...
 String get categoryId; List<String> get images; List<ProductColorEntity> get colors; DateTime get createdDate; num get discountedPrice; int get gender; List<String> get sizes; String get title; String get productId; num get price; int get salesNumber;
...
@override
String toString() {
  return 'ProductEntity(categoryId: $categoryId, images: $images, colors: $colors, createdDate: $createdDate, discountedPrice: $discountedPrice, gender: $gender, sizes: $sizes, title: $title, productId: $productId, price: $price, salesNumber: $salesNumber)';
}
...
@useResult
$Res call({
 String categoryId, List<String> images, List<ProductColorEntity> colors, DateTime createdDate, num discountedPrice, int gender, List<String> sizes, String productId, num price, int salesNumber, String title
});
...
as List<ProductColorEntity>,null == createdDate ? _self.createdDate : createdDate // ignore: cast_nullable_to_non_nullable
